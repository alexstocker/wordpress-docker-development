...
class Boilerplate {
	...
	public function __construct() {
		if ( defined( 'BOILERPLATE_VERSION' ) ) {
			$this->version = BOILERPLATE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Boilerplate_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Boilerplate_Public( $this->get_plugin_name(), $this->get_version() );
